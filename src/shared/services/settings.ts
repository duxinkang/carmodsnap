...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    },
    {
      name: 'qwen',
      title: 'Qwen (通义万相)',
      description: `Custom <a href="https://dashscope.console.aliyun.com/" class="text-primary" target="_blank">Qwen</a> settings`,
      tab: 'ai',
    },
    {
      name: 'adsense',
...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      type: 'text',
      placeholder: 'www.carmodsnap.com',
      group: 'plausible',
      tab: 'analytics',
    },
    {
    ...
    },
    {
      ...
      type: 'text',
      placeholder: 'CarModSnap <no-reply@mail.carmodsnap.com>',
      group: 'resend',
      tab: 'email',
    },
    {
    ...
    },
    {
      ...
      placeholder: 'sk-xxx',
      group: 'qwen',
      tip: 'Qwen (通义万相) API Key from Aliyun DashScope',
      tab: 'ai',
    },
    {
      name: 'qwen_base_url',
    ...
    {
      name: 'qwen_custom_storage',
      title: 'Qwen Custom Storage',
      type: 'switch',
      value: 'false',
      group: 'qwen',
      tab: 'ai',
      tip: 'Use custom storage to save files generated by Qwen',
    },
    {
      name: 'adsense_code',
      title: 'Adsense Code',
