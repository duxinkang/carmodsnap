...
Welcome to **CarModSnap**, the AI-powered car modification visualization platform. At CarModSnap, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.
...
We collect the following types of data to provide you with a better experience while using CarModSnap:
...
2. **Usage Details**
   - **What We Collect**: Information about how you use CarModSnap, including your interactions, features accessed, and usage frequency.
   - **Purpose**: To analyze user engagement and improve our services.

3. **Device Information**
   - **What We Collect**: Data regarding the devices you use to access CarModSnap, such as device type, operating system, and browser type.
...
5. **Payment and Billing Information**
   - **What We Collect**: Billing-relevant information such as plan, transaction status, payer email, country, and invoice/receipt metadata returned by our payment provider.
   - **What We Do Not Store**: We do not store full card numbers or card security codes on CarModSnap servers.
   - **Purpose**: To facilitate billing, subscription management, invoicing, and payment support.
...
**Copyright Owner**: [carmodsnap.com](https://carmodsnap.com)
**Email**: [support@carmodsnap.com](mailto:support@carmodsnap.com)

By using CarModSnap, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
