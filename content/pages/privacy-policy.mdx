...
description: Privacy policy for ModSnap
...
Welcome to **ModSnap**, the AI-powered car modification visualization platform. At ModSnap, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using ModSnap:
...
2. **Usage Details**
   - **What We Collect**: Information about how you use ModSnap, including your interactions, features accessed, and usage frequency.
   - **Purpose**: To analyze user engagement and improve our services.

3. **Device Information**
   - **What We Collect**: Data regarding the devices you use to access ModSnap, such as device type, operating system, and browser type.
...
**Copyright Owner**: [modsnap.tech](https://modsnap.tech)
**Email**: [contact@startpointagency.com](mailto:contact@startpointagency.com)

By using ModSnap, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
